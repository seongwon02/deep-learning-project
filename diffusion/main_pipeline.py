...
def run_pipeline(image_path, json_path, prompt, output_path):
    ...
    print("Initializing SDXL Inpainter (Seamless Blending & Color Transfer)...")
    ...
    result_image = inpainter.inpaint(
    ...
    print(f"Seamless result saved to: {output_path}")
...
if __name__ == "__main__":
    ...
    if not os.path.exists(json_path):
        ...
        output_path = os.path.join(base_dir, "final_character_result.jpg")
        prompt = "person"
        run_pipeline(img_path, json_path, prompt, output_path)
